...
namespace AircompanyTests.Tests
{
    ...
    public class AirportTest
    {
        ...
        public void Test1()
        {
            ...
            Assert.IsTrue(transportMilitaryPlanes.Any(p => p.GetPlaneType() == MilitaryType.Transport));
        }
        ...
        public void Test3()
        {
            ...
            var s = from p in airport.GetPlanes().ToList()
                    orderby p.MaxLoadCapacity()
                    select p;
            Assert.AreSame(s, planesSortedByMaxLoadCapacity);
        }
    }
}
